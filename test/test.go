// Package test has some shared testing utilities.
package test

// Prog contains the source for
// code.google.com/p/plotinum/plot/plot.go at revision
// 3c9a512eeb7a. This is a fixed program that is useful for
// benchmarking.
const Prog = `
